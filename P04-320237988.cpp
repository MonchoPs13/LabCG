...
int main()
{
	...
	*/
	...
	//primer brazo que conecta con la cabina
		...
		model = glm::translate(model, glm::vec3(1.0f, 1.25f, 1.0f));
		modelaux = model;

		model = glm::scale(model, glm::vec3(0.75f, 0.5f, 0.75f));
	...
	while (!mainWindow.getShouldClose())
	{
		...
		std::vector<GLfloat> rotations = {
			mainWindow.getarticulacion1(), // F
			mainWindow.getarticulacion2(), // G
			mainWindow.getarticulacion3(), // H
			mainWindow.getarticulacion4(), // J
			mainWindow.getarticulacion5(), // K
			mainWindow.getarticulacion6(), // L
			mainWindow.getarticulacion7(), // O
			mainWindow.getarticulacion8(), // P
			mainWindow.getarticulacion9(), // I
		};

		//renderGrua();
		dog.Render(shaderList[0], camera, rotations);
